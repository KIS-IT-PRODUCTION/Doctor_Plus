...
import { createClient } from '@supabase/supabase-js'; // Тепер посилається на імпорт з deno.json
import { Expo } from 'expo-server-sdk'; // Тепер посилається на імпорт з deno.json
