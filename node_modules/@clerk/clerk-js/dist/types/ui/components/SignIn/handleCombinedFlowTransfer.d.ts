import type { LoadedClerk, PhoneCodeChannelData, SignUpModes } from '@clerk/types';
 ...
 */
export declare function handleCombinedFlowTransfer({ identifierAttribute, identifierValue, signUpMode, navigate, organizationTicket, afterSignUpUrl, clerk, handleError, redirectUrl, redirectUrlComplete, passwordEnabled, alternativePhoneCodeProvider, }: HandleCombinedFlowTransferProps): Promise<unknown> | void;
export {};
